            ...
            success: function (cityJson) {
                ...
                if(seriesData.length==0){
                    ...
                    if(chartConfig.option.visualMap && chartConfig.option.visualMap.max && chartConfig.option.visualMap.min){
                        if(Math.floor(chartConfig.option.visualMap.max) > Math.floor(chartConfig.option.visualMap.min)){
                        ...
                        if( chartConfig.option.visualMap &&  chartConfig.option.visualMap.max &&  Math.floor(chartConfig.option.visualMap.max)>=0){
                            mapOption.visualMap.max = Math.floor(chartConfig.option.visualMap.max);
                        }
                        if( chartConfig.option.visualMap &&  chartConfig.option.visualMap.min &&  Math.floor(chartConfig.option.visualMap.min)>=0){
                            mapOption.visualMap.min = Math.floor(chartConfig.option.visualMap.min);
                        }
                    }
                }
